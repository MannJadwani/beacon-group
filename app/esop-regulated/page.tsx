...
// Hardcoded data for ESOP page
const ESOP_DATA = {
  title: "ESOP Trustee",
  intro: "Trustee for ESOP - Employee Stock Options Plan for the plan / scheme offered pursuant to Securities and Exchange Board of India (Share Based Employee Benefits and Sweat Equity) Regulations, 2021",
  sections: [
    {
      id: "services",
      title: "Being a one-stop Trustee to our clients, we also offer",
      bullets: [
...
export default function EsopRegulatedPage() {
  const { title, intro, sections, alsoOffer, offices } = ESOP_DATA;
